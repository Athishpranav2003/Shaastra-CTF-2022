...
app = Flask(__name__)
os.environ.setdefault('FLAG', 'ShaastraCTF{Dev_t001s_are_dan9ger0u5_t0_u5e}')
...
def index_post():
    ...
    if(bool(re.match('^[a-zA-Z0-9-\ ]*$',new_city))==True):
    	...
    	raise KeyError("Wrong characters were inputted")
